...
public class Oracle extends Database { //This class inherited from database class.
	
	public static int countOracle=0;//These counters will use to find the adding expression is implemented or not.
	public static int countOracleDriver=0;
	public static int countOracleBusStop=0;
	public static int countOracleService=0;
	public static int countOracleRoute=0;
	public static int control;//This is for the control method.
